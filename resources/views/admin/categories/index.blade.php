...
@section('content')
            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="card-tools">
                        ...
                        <a href="/admin/categories/print" class="btn btn-primary btn-sm" target="_blank">Cetak</a>
                    </div>
                </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="#" class="btn btn-danger btn-sm" data-toggle="modal"
                                            data-target="#modal-hapus" data-id="{{ $category->id }}"
    ...
    <script>
        $(document).on('click', '#btn-hapus', function() {
            ...
            $('#form-hapus').attr('action', '/admin/categories/' + id);
        });
    </script>
@endsection
